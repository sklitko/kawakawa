...
thirdscreen:
  accordion:
    ...
    - text: >-
        Якщо кава відсутня в нашому каталозі, відскануйте штрих-код на пачці або
        зробіть знімок пачки, заповніть форму, а потім надішліть нам, ми вивчимо
        цю каву і додамо в наш каталог. Діліться своєю думкою, якщо ви кавоман.
