...
fourthscreen:
  ...
  list:
    - items:
        - Эксклюзивный дизайн
    - items:
        - Основные функции доступны без регистрации
    - items:
        - Удобный интерфейс заказа и оплаты
    - items:
        - Контроль за статусом заказа в личном кабинете
    - items:
        - Энциклопедия кофейных брендов и рецептов
    - items:
        - Отсутствие рекламы
    - items:
        - Видеообзоры о кофе
